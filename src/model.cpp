    ...
    if (argv[1][0] == '1') {
        #pragma omp parallel
        {
            ...
            switch(tid) {
                ...
                case 0: m.init(n, 10000.0, 100.0, 0.2, 0.1, 1.0/5, 1.0/3, fname); m.run(); break;
                case 1: m.init(n, 5000.0, 100.0, 0.2, 0.1, 1.0/5, 1.0/3, fname); m.run(); break;
                case 2: m.init(n, 3000.0, 100.0, 0.2, 0.1, 1.0/5, 1.0/3, fname); m.run(); break;
                case 3: m.init(n, 1000.0, 100.0, 0.2, 0.1, 1.0/5, 1.0/3, fname); m.run(); break;
                case 4: m.init(n, 500.0, 100.0, 0.2, 0.1, 1.0/5, 1.0/3, fname); m.run(); break;
                case 5: m.init(n, 300.0, 100.0, 0.2, 0.1, 1.0/5, 1.0/3, fname); m.run(); break;
                case 6: m.init(n, 100.0, 100.0, 0.2, 0.1, 1.0/5, 1.0/3, fname); m.run(); break;
                case 7: m.init(n, 10.0, 100.0, 0.2, 0.1, 1.0/5, 1.0/3, fname); m.run(); break;
                default: ;
            }
        }
    } else {
